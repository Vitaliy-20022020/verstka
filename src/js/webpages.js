...
// call calendar
$('.datepicker-here').datepicker({position: "bottom right",
clearButton: "true",
autoClose: 'true',
showEvent: 'click',
});
...
$('.landingpage__arrival').trigger('click');
});
//departure
$('#datepicker-heredeparture').on('click', function(){
$('.landingpage__departure').trigger('click');
});
//form guests and select amount guests
$('#guests, .list').on('click', function(){
  $('.landingpage__title').slideToggle('fast');
  });
  
  $('.list').click(function(){
   let list = $(this).html();
   $('.landingpage__formguests').val(list);
  });
